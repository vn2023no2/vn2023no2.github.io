...
## Windows
+ Giữ cho ở C luôn nhiều dung lượng
+ Xóa App chưa chắc sẽ xóa hết các file hoặc thư mục được tạo ==> Cần phải kiểm tra lại
+ Để một phân vùng trống sau ổ C để có thể mở rộng
